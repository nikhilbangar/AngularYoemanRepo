...
qaApp.controller("ReportForMobileController", ["$scope", "$location", "$routeParams", "JDPAFactory",
    function ($scope, $location, $routeParams, JDPAFactory) {
        ...
        JDPAFactory.getListOfReport("Mobile",
        ...
        $scope.changeReportSelect = function (reportName) {
            if (reportName != null) {
                JDPAFactory.getPlatformsForMobileReport(reportName,
                    function (data, status, headers, config) {
                        reportData = data;
        ...
        function getReportByBrowserName(browser) {
            ...
            if ($scope.totalTestcases > 0) {
                ...
                $scope.buildNo = reportData.BuildNo;
